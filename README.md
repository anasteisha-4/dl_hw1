...
1. dropout_p = 0.01  
   ...
   При p = 0.01 наблюдается наивысший итоговый Val ROC-AUC среди всех экспериментов (0.9186)
2. dropout_p = 0.1  
   Train Loss снижается с 0.3042 → 0.2303, Val Loss с 0.2478 → 0.2135, Val ROC-AUC плавно и стабильно растет до 0.9172.
